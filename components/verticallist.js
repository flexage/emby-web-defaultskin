define(['loading', './focushandler', 'focusManager', 'cardBuilder'], function (loading, focusHandler, focusManager, cardbuilder) {
    ...
    verticalList.prototype.render = function () {
    ...
    verticalList.prototype.onItemsResult = function (result) {
        ...
        // cardOptions.rows.portrait = result.TotalRecordCount / 4;
        // cardOptions.rows.square = result.TotalRecordCount / 4;
        // cardOptions.rows.backdrop = result.TotalRecordCount / 4;
    ...
    verticalList.prototype.onAutoFocusTimeout = function () {
    ...
    verticalList.prototype.destroy = function () {
